export default {
  ...
  home: {
    'page-title': 'Genuine cellphone and accessories | NatureScent',
    cart: 'Cart',
  ...
  account: {
    'page-title': 'Account | NatureScent',
    info: 'Info',
    order: 'Order',
  ...
  cart: {
    'page-title': 'Shopping cart | NatureScent',
    title: 'Cart',
  ...
  order: {
    'page-title': 'Orders | NatureScent',
    'dashboard-page-title': 'Order Management | NatureScent',
    heading: 'Order List',
    title: 'Order',
  ...
  auth: {
    'page-title': {
      login: 'Log in | NatureScent',
      register: 'Register | NatureScent',
      'reset-password': 'Reset password | NatureScent'
    },
    ...
    'accept-terms': 'By registering, I agree to NatureScent',
    tos: 'Terms of Service',
    'privacy-policy': 'Privacy Policy',

    'register-salutation': 'Hi, Welcome to NatureScent',
  ...
  dashboard: {
    ...
    categories: {
      'page-title': 'Category management | NatureScent',
    ...
    brands: {
      'page-title': 'Brand management | NatureScent',
      title: 'Brands',
    ...
    discounts: {
      'page-title': 'Discount management | NatureScent',
      title: 'Discounts',
    ...
    users: {
      'page-title': 'User management | NatureScent',
      title: 'Users',
      heading: 'User List',
  ...
  products: {
    'page-title': 'Product management | NatureScent',
    title: 'Products',
    list: 'Product list',
    ...
    save: 'Save Changes',
    'add-title': 'Ecommerce: Add new product | NatureScent',
    'add-success': 'Successfully added product.',
    edit: 'Edit product',
    'edit-title': 'Ecommerce: Edit new product | NatureScent',
    ...
    'infor-1-content': 'All products at NatureScent are genuine in Vietnam',
